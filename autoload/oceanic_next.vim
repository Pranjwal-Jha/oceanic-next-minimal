...
function! oceanic_next#highlight( base00, base01, base02, base03, base04, base05, base06, base07, red, orange, yellow, green, cyan, blue, purple, brown, white, none) abort
  ...
  call s:hi('Normal',                            a:base07, a:none, '',          '')
  call s:hi('EndOfBuffer',                       a:base05, a:none, '',          '')
  call s:hi('LineNr',                            a:base03, a:none, '',          '')
  call s:hi('SignColumn',                        a:base00, a:none, '',          '')
  call s:hi('StatusLine',                        a:base01, a:base03, '',          '')
  call s:hi('StatusLineNC',                      a:base03, a:none, '',          '')
  call s:hi('VertSplit',                         a:base01, a:none, '',          '')
  call s:hi('ColorColumn',                       '',       a:none, '',          '')
  call s:hi('CursorColumn',                      '',       a:none, '',          '')
  call s:hi('CursorLine',                        '',       a:none, 'None',      '')
  call s:hi('CursorLineNR',                      a:base00, a:none, '',          '')
  ...
  call s:hi('TabLine',                           a:base03, a:none, '',          '')
  call s:hi('TabLineFill',                       a:base03, a:none, '',          '')
...
if has('nvim')
    call s:hi('@keyword.import',                          a:purple, '',       '',          '')
    ...
    call s:hi('@namespace',                        a:base05, '',       '',          'bold')
